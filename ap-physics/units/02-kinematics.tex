...
\centering
    \begin{tikzpicture}
        ...
        \draw[black,thick,domain=19:32] plot(\x,140*\x-1350);
        \node[above left=-2pt] at (25,2138) {Q};
        \draw[dashed] (19,1300) -- ++(13,0) node[below,pos=0.5] {$\Delta t_{\text{Q}}$};  %140*19-1360 = 1300
        \draw[dashed] (32,1300) -- ++(0,1820) node[right,pos=0.5] {$\Delta x_{\text{Q}}$}; %140*32 - 1360 = 3120; 3120 - 1300 = 1820
        \end{axis}
    \end{tikzpicture}%
\end{minipage}%
\hspace{1em}
