    ...
    \begin{tikzpicture}
        \begin{axis}[width=4cm,
            ...
            \begin{scope}[shift={(axis direction cs: -4,0)}]
                ...
                \draw[violet,thick,->] (-0.5,0.8) -- ++(axis direction cs: -2,0) node[pos=0.5,above] {$a =\ ?$};
...
\begin{minipage}{7cm}
    ...
    \begin{tikzpicture}
        \begin{axis}[width=6cm, height=3cm,
            ...
            \draw[thick,violet] plot[,domain=0:5,variable=\x,samples=100] (\x,{0.5*sin(125*\x) + 1.8});
...
\begin{minipage}{7cm}
    ...
    \begin{tikzpicture}
        ...
        \addplot[violet,mark=none,thick]
            coordinates{
