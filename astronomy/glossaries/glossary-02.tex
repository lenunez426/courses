...
\newglossaryentry{zodiac}{
    name=zodiac,
    description={a belt around the sky about \ang{18} wide centered on the ecliptic}
}
...
\newglossaryentry{parallax}{
    name=parallax,
    description={the apparent displacement of a nearby star that results from the motion of Earth around the Sun}
}

\newglossaryentry{retrograde motion}{
    name=retrograde motion,
    description={the apparent westward motion of a planet on the celestial sphere or with respect to the stars}
}

\newglossaryentry{epicycle}{
    name=epicycle,
    description={the circular orbit of a body in the Ptolemaic system, the center of which revolves about another circle (the deferent)}
}
