...
\clearpage
\subsection{Lab: Factors that Affect Path and Hang Time \texttt{(Monday 01/08/2024)}} \label{1hGIbN}
...
\subsection{Describing Vertical and Horizontal Motion} \label{pW3BPZ}
...
\begin{center}
    \begin{tikzpicture} 
        ...
        \draw[dashed,domain=0:16,variable=\x,samples=200] plot ({\x},{patheq(\x,0,18,70)}) node[above left=-4pt] {\faSoccerBallO};
        \draw[RoyalBlue,->,thick] (0,0) -- ++(16,{patheq(16,0,18,70)}) node[pos=0.5,above=3pt]{$d$} node[black,right] {$(16,23)$};
